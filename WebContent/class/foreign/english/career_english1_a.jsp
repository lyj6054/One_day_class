	...
	<div class="left">
		...
		<div class="a-left">
			...
			<div class="a-left-2" style="width:281px;">
				<p class="a-title-1">(12/6 온라인)[원데이] 3시간만에 끝내는 영어회화 공부법! 앞으론 '이것'만 하자!</p><br>
				<span class="a-title-2">4.9</span>
			</div>
		</div>
		<h3>수업 일정을 먼저 선택해주세요.</h3>
		<div class="scroll-box">
			<div class="left-box" style="height:220px;">
				<ul>
					<div>
						<li>
							<label>
								<input type="radio" name="lradio" id="leftradio">
								<span class="left-box-span">12월 06일 일요일 (온라인 Live) 12:00 - 15:00</span>
					...
					<div>
						<li>
							<label>
								...
								<span class="left-box-span">12월 19일 토요일 (온라인 Live) 19:00 - 22:00</span>
								<p class="left-box-p">협의 후 상세 장소 결정</p>
							</label>
						</li>
					</div>
