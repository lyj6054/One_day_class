 ...
 *:focus { outline:none; }
	*{
	...
	div.left-box_w_a_2_a>ul>li>label>span.left-box-span {
		font-size:15px;
		font-weight:bold;
		margin-left:10px;
	}
	div.left-box_w_a_2_a>ul>li>label>p.left-box-p {
		color:gray;
		margin-left:35px;
		font-size:15px;
	}
	div.left-box_w_a_2_a>ul>hr {
		width:350px;
		opacity:0.2;
		margin-top:30px;
		margin-bottom:20px;
   ...
   input[type="radio" i] {
    ...
    .left-box_w_a_2_a .inp_radio {
       position:relative;
    }
    label {
       cursor:pointer;
    }
   .left-box_w_a_2_a .inp_radio::before {
       content: '';
       display: block;
       position: absolute;
       left: -36px;
   ...
   .left-box_w_a_2_a .list .inp_label:checked + .inp_radio::before {
...
<body>
	...
	<div class="left">
		...
		<div class="a-left">
			<div class="a-left-1">
				<img src="http://localhost:9000/One_day_class/images/workout/w_a_2.png">
				<span class="a-title-1">무용전문스튜디오 R.se에서 진행되는 현<br>대무용 전문 클래스!</span><br>
				<div class="a-left-2">
