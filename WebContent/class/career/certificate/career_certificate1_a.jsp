	...
	<div class="left">
		...
		<div class="a-left">
			...
			<div class="a-left-2" style="width:281px;">
				<p class="a-title-1">[ 한국사 능력 시험 ] 핵심만 뽑아서 한큐에 합격하기! ( 온라인 강의 포함 )</p><br>
				...
				<ul>
					...
					<div>
						<li>
							<label>
								...
								<span class="left-box-span">협의 후 날짜 결정 (잠실새내) 협의 후 시간 결정</span>
								<p class="left-box-p">협의 후 상세 장소 결정</p>
							</label>
							<hr>
						</li>
					...
					<div>
						<li>
							<label>
								<input type="radio" name="lradio">
								<span class="left-box-span">협의 후 날짜 결정 (시흥) 협의 후 시간 결정</span>
								<p class="left-box-p">협의 후 상세 장소 결정</p>
							</label>
							<hr>
						</li>
					...
					<div>
						<li>
							<label>
								<input type="radio" name="lradio">
								<span class="left-box-span">협의 후 날짜 결정 (사당) 협의 후 시간 결정</span>
								<p class="left-box-p">협의 후 상세 장소 결정</p>
							</label>
						</li>
					</div>
