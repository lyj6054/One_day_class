	...
	<div class="left">
		...
		<div class="a-left">
			...
			<div class="a-left-2" style="width:281px;">
				<p class="a-title-1">[원데이영상편집1위/기초]영상편집, 4시간으로 프리미어 깨부시기!(온라인/오프라인모두가능)</p><br>
					...
					<div>
						<li>
							<label>
								...
								<span class="left-box-span">12월 06일 일요일 (신촌홍대) 10:00 - 14:00</span>
								<p class="left-box-p">홍대입구</p>
							</label>
							<hr>
						</li>
					</div>
					<div>
						<li>
							<label>
								...
								<span class="left-box-span">12월 09일 수요일 (신촌홍대) 10:00 - 14:00</span>
								<p class="left-box-p">홍대</p>
							</label>
						</li>
					</div>
					<div>
						<li>
							<label>
								<input type="radio" name="lradio">
								<span class="left-box-span">12월 13일 일요일 (강남) 14:00 - 18:00</span>
								<p class="left-box-p">강남</p>
							</label>
						</li>
					</div>
					<div>
						<li>
							<label>
								<input type="radio" name="lradio">
								<span class="left-box-span">12월 15일 화요일 (강남) 10:00 - 14:00</span>
								<p class="left-box-p">홍대입구.영등포</p>
							</label>
						</li>
					</div>
					<div>
						<li>
							<label>
								<input type="radio" name="lradio">
								<span class="left-box-span">12월 20일 일요일 (신촌홍대) 17:00 - 21:00</span>
								<p class="left-box-p">홍대</p>
							</label>
						</li>
					</div>
