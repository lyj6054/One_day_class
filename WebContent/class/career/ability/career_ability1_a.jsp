...
<body>
	...
	<div class="left">
		...
		<div class="a-left">
			<div class="a-left-1">
				<img src="http://localhost:9000/One_day_class/images/career/ability/ability2_ (1).png">
			</div>
			
			<div class="a-left-2" style="width:281px;">
				<p class="a-title-1">[중급] 하루에 끝내는 논리적 보고서-PPT 시각화</p><br>
				...
				<ul >
						<li class="list">
								...
								<label for="leftradio1" class="inp_radio">
									<span class="left-box-span">12월 06일 (일) 12:00-15:00</span>
						...
						<li class="list">
								...
								<label for="leftradio2" class="inp_radio">
									<span class="left-box-span">12월 20일 (일) 12:00-15:00</span>
									<p class="left-box-p">협의 후 결정</p>
								</label>
						</li>
						<li class="list" style="border-bottom:none;">
								...
								<label for="leftradio3" class="inp_radio">
									<span class="left-box-span">01월 03일 (일) 12:00-15:00</span>
									<p class="left-box-p">협의 후 결정</p>
								</label>
						</li>
				</ul>
