...
<div class="tutor_cont">
   <div class="title_box">
    ...
    <div class="box">
      ...
      <div class="cont" style="padding-top:15px">
         <div class="inner1">
            <textarea class="basic len980 hei190" placeholder="수강생에게 해주고싶은 튜터님의 수업숙지사항을 입력해주세요." id="TutorInfo" name="tutornotice"><%=vo.getTutornotice() %></textarea>
         </div>
      </div>
   </div>
   ...
   <div class="box">
      ...
      <div class="cont" style="padding-top:15px">
         ...
         <div class="inner1">
            <textarea class="basic len980 hei190" placeholder="수강생은 튜터님에 대해 많은 관심을 가지고 있습니다. TIP을 참고하여 최대한 자세히 소개를 해주세요." id="TutorInfo" name="tutorinfo"><%=vo.getTutorinfo() %></textarea>
         </div>
         <div class="inner1">
            <div class="sample1">
               <div class="arw">
         ...
         <div class="caution caution2">
            ...
            <ul class="gray8">
               ...
               <br>강조를 해야 할 내용이 있는 경우 되도록이면 일반 특수문자(★/◎/♡)를 사용해주세요
                  ...
                  <div class="inner1">
            <textarea class="basic len980 hei190" placeholder="수업소개는 수강생이 가장 주의깊게 살펴보는 부분입니다. 수강생들이 수업에 대해 알 수 있도록 TIP의 질문을 반드시 포함하여 작성해주세요." id="Introduction" name="introduction"><%=vo.getIntroduction() %></textarea>
         </div>
   ...
   <div class="box">
      ...
      <div class="cont">
         ...
         <div class="inner1">
            <textarea class="basic len980 hei190" placeholder="TIP의 내용을 참고하여 튜터님의 수업을 수강하기에 적합한 수업대상에 대해 알려주세요. " id="Target" name="target"><%=vo.getTarget() %></textarea>
         </div>
         <div class="sample1 inner1">
            <div class="arw">
               <img class="button" src="https://front-img.taling.me/Content/Images/tutor/Images/icon_down.png" onclick="arwpaper(this)">
      ...
      <div class="cont">
         ...
         <!--여기서부터 커리큘럼 가져와서 붙인것 from Tutor2/default03.php-->
               <div class="curri inner1"id="Curri1" style="margin-bottom:20px;">
                  ...
                  <div class="box">
                  <textarea class="basic len980" placeholder="커리큘럼을 입력해 주세요." id="Curriculum1" name="curriculum"><%=vo.getCurriculum() %></textarea>
                  </div>
