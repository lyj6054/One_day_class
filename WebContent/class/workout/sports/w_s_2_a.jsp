 ...
 *:focus { outline:none; }
	*{
	...
	div.left-box_w_s_2_a>ul>li>label>span.left-box-span {
		font-size:15px;
		font-weight:bold;
		margin-left:10px;
	}
	div.left-box_w_s_2_a>ul>li>label>p.left-box-p {
		color:gray;
		margin-left:35px;
		font-size:15px;
	}
	div.left-box_w_s_2_a>ul>hr {
		width:350px;
		opacity:0.2;
		margin-top:30px;
		margin-bottom:20px;
   ...
   input[type="radio" i] {
    ...
    .left-box_w_s_2_a .inp_radio {
       position:relative;
    }
    label {
       cursor:pointer;
    }
   .left-box_w_s_2_a .inp_radio::before {
       content: '';
       display: block;
       position: absolute;
       left: -36px;
   ...
   .left-box_w_s_2_a .list .inp_label:checked + .inp_radio::before {
...
<body>
	...
	<div class="left">
		...
		<div class="a-left">
			<div class="a-left-1">
				<img src="http://localhost:9000/One_day_class/images/workout/w_s_2.png">
				<span class="a-title-1">[원데이] FBI가 배우는 실전 호신술 크라<br>브마가 : #여성호신술 #영화속무술</span><br>
				<div class="a-left-2">
		...
		<div class="left-box_w_s_2_a">
			<ul>
					<li class="list">
						<input type="radio" name="lradio" id="leftradio1" class="inp_label blind">
						<label for="leftradio1" class="inp_radio">
							<span class="left-box-span">12월 05일 토요일 () 14:00 - 15:00</span>
							<p class="left-box-p">교대역 1번출구</p>
						</label>
					</li>
						<hr>
					<li class="list">
						...
						<label for="leftradio2" class="inp_radio">
							<span class="left-box-span">12월 12일 토요일 () 14:00 - 15:00</span>
							<p class="left-box-p">교대역</p>
						</label>
					</li>
			</ul>
		</div>
